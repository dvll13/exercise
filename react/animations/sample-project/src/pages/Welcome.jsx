...
export default function WelcomePage() {
  ...
  // these don't make component re-render on value recalculation
  const yCity = useTransform(scrollY, [0, 200], [0, -100])
  const opacityCity = useTransform(scrollY, [0, 200, 300, 500], [1, 0.5, 0.5, 0]) // scroll px, corresponding opacity value
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        {/* style prop is enhanced, monitored and animated by framer motion */}
        <motion.img
          src={cityImg}
