...
export default function Checkout() {
  ...
  function handleSubmit(e) {
    // since the browser sends an http request by default
    e.preventDefault()

    const fd = new FormData(e.target)
    const customerData = Object.fromEntries(fd.entries()) // {email: ..., name: ...}
  ...
  // if we succeeded and have a valid response
  if (data && !error) {
    return (
